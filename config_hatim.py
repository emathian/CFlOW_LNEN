...
def get_args():
    ...
    parser.add_argument('-wd', '--weights-dir', default='/gpfsscratch/rech/ohv/ueu39kt/CFLOW/weights/carpet_parallel_no_distribution_test_set_0710', type=str, metavar='C', help='result outputdir')
