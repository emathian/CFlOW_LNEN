...
def train(c):
    ...
    # Model
    # @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    # Note: The weights of the encoder are not updated.
    # There are 3 decoders whose the weights are updated.
    ...
    params = list(ddp_decoders[0].parameters())
    for l in range(1, L):
    ...
    # Test set
    # Note : The test set is not distributed.
    ...
    for epoch in range(c.meta_epochs):  
        if c.action_type == 'norm-test' and c.checkpoint:
            ...
            P = c.condition_vec
            L = c.pool_layers
            ddp_decoders = [decoder.train() for decoder in ddp_decoders]
            ...
            for sub_epoch in range(c.sub_epochs):
                ...
                for i, ddp_decoder in enumerate(ddp_decoders):
                    filename = '{}_mataepoch_{}_subepoch_{}_decoder_{}.pt'.format(c.model, epoch_s, sub_epoch_s, i)
