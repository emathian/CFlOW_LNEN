#!/bin/bash
#SBATCH --job-name=CFlowLCNECLike_Massimo_VAL2
...
#SBATCH --output=CFlowLCNECLike_Massimo_VAL2.out          # nom du fichier de sortie
#SBATCH --error=CFlowLCNECLike_Massimo_VAL2.error     
