#!/bin/bash
#SBATCH --job-name=CFlowLCNECLike_Massimo_VAL4
...
#SBATCH --output=CFlowLCNECLike_Massimo_VAL4.out          # nom du fichier de sortie
#SBATCH --error=CFlowLCNECLike_Massimo_VAL4.error     
