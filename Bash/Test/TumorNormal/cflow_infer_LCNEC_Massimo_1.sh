#!/bin/bash
#SBATCH --job-name=CFlowLCNECLike_Massimo_1
...
#SBATCH --output=CFlowLCNECLike_Massimo_1.out          # nom du fichier de sortie
#SBATCH --error=CFlowLCNECLike_Massimo_1.error     
