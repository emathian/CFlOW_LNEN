#!/bin/bash
#SBATCH --job-name=CFlowLCNECLike_Massimo_VAL5-9
...
#SBATCH --output=CFlowLCNECLike_Massimo_VAL5-9.out          # nom du fichier de sortie
#SBATCH --error=CFlowLCNECLike_Massimo_VAL5-9.error     
