#!/bin/bash
#SBATCH --job-name=CFlowLCNECLike_CLB_TNE
...
#SBATCH --output=CFlowLCNECLike_CLB_TNE06-9.out          # nom du fichier de sortie
#SBATCH --error=CFlowLCNECLike_CLB_TNE06-9.error     
