#!/bin/bash
#SBATCH --job-name=CFlowLCNECLike_Massimo_3
...
#SBATCH --output=CFlowLCNECLike_Massimo_3.out          # nom du fichier de sortie
#SBATCH --error=CFlowLCNECLike_Massimo_3.error     
