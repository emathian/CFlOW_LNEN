#!/bin/bash
#SBATCH --job-name=CFlow_Infer_AC0_segmented_ITVAL4-5
...
#SBATCH --output=CFlow_Infer_AC0_segmented_ITVAL4-5.out          # nom du fichier de sortie
#SBATCH --error=CFlow_Infer_AC0_segmented_ITVAL4-5.error     
