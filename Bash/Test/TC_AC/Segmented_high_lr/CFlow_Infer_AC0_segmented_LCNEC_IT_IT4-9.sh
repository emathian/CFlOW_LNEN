#!/bin/bash
#SBATCH --job-name=CFlow_Infer_AC0_segmented_IT4-9
...
#SBATCH --output=CFlow_Infer_AC0_segmented_IT4-9.out          # nom du fichier de sortie
#SBATCH --error=CFlow_Infer_AC0_segmented_IT4-9.error     
