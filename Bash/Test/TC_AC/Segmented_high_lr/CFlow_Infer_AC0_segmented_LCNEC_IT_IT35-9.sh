#!/bin/bash
#SBATCH --job-name=CFlow_Infer_AC0_segmented_IT35-9
...
#SBATCH --output=CFlow_Infer_AC0_segmented_IT35-9.out          # nom du fichier de sortie
#SBATCH --error=CFlow_Infer_AC0_segmented_IT35-9.error     
