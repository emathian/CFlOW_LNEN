#!/bin/bash
#SBATCH --job-name=CFlow_Infer_AC0_segmented_TNE087
...
#SBATCH --output=CFlow_Infer_AC0_segmented_TNE087.out          # nom du fichier de sortie
#SBATCH --error=CFlow_Infer_AC0_segmented_TNE087.error     
