#!/bin/bash
#SBATCH --job-name=CFlow_Infer_AC0_segmented_TNE056-9
...
#SBATCH --output=CFlow_Infer_AC0_segmented_TNE140-1.out          # nom du fichier de sortie
#SBATCH --error=CFlow_Infer_AC0_segmented_TNE140-1.error     
