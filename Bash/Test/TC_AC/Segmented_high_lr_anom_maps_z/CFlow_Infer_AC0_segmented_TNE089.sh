...
#SBATCH --output=CFlow_Infer_AC0_segmented_TNE089.out          # nom du fichier de sortie
#SBATCH --error=CFlow_Infer_AC0_segmented_TNE089.error     
