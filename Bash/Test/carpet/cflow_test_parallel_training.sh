...
echo ========================================================================
srun python /linkhome/rech/genkmw01/ueu39kt/cflow-ad/main_cflow.py --gpu 0 -inp 512 --action-type norm-test --dataset mvtec --class-name carpet --gpu 0 --checkpoint  /gpfsscratch/rech/ohv/ueu39kt/CFLOW/weights/carpet_parallel_0310/carpet/3/mvtec_wide_resnet50_2_freia-cflow_pl3_cb8_inp512_run0_carpet_3_0.pt
