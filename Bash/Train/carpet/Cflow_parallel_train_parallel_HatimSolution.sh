...
#SBATCH --output=CFlowOnImageNet_carpet_train_parallel_hatim_solution.out          # nom du fichier de sortie
#SBATCH --error=CFlowOnImageNet_carpet_train_parallel_hatim_solution.error     
