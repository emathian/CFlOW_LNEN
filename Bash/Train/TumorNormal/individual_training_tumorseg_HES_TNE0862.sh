...
#SBATCH --output=CFlowOnImageNet_Tumor_HES_individual_TNE0862.out          # nom du fichier de sortie
#SBATCH --error=CFlowOnImageNet_Tumor_HES_individual_TNE0862.error     
