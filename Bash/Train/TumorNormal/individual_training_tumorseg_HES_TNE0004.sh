...
#SBATCH --output=CFlowOnImageNet_Tumor_HES_individual_TNE0004.out          # nom du fichier de sortie
#SBATCH --error=CFlowOnImageNet_Tumor_HES_individual_TNE0004.error     
...
srun python /linkhome/rech/genkmw01/ueu39kt/cflow-ad/main_cflow.py --gpu 0 -inp 384 --dataset TumorNormal --class-name Tumor  --root-data-path /gpfsscratch/rech/ohv/ueu39kt/TumoralNormalForFastFlow_difficult_cases --weights-dir /gpfsscratch/rech/ohv/ueu39kt/CFLOW/weights/TumorSeg_HES_individual_training_TNE0004 --list-file-train TNE0004_test_individual_segmentation_model.txt --list-file-test TNE0004_train_individual_segmentation_model.txt --meta-epochs 30 --sub-epochs 8  --lr 2e-4
